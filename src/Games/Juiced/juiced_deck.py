...
BLACK_CAH:dict = {
	...
	"In his new selfproduced album, Kanye West raps over the sounds of ______." : 1,
	...
	'''I'll take the BBQ bacon burger with fried egg and fuck it how about ______.''' : 1,
...
WHITE_CODERS:dict = {
    ...
    "Janice lore being real": 1,
    "A happy and glorious New Year, you slut-guzzling cum lords!!!": 1,
    "It's 2025! How the heck did that happen! Time is soup!": 1,
    '''A rich gumbo of unending horror, failed dreams, and occasional bowling nights that you really don't feel like going to but your manager Dale from work set it up and you're already not on the "best of terms" to put it mildly so you really don't wanna pull on that thread and plus Janice from accounting seems really excited about it and you know she hasn't been able to get out much since she had her kids and socializing with other adults in really important for one's mental health and she's always been really nice bringing snacks for the office and you'd probably feel kinda guilty eating her sick-ass cupcakes if you bailed on bowling and you would literally murder a family of ducks before you'd let anything diminish the transcendent moment when you slam those exquisite sugar mounds straight into your eager gullet because you know that they're the product of the expert craftmanship of a hardworking wife and mother GOD Jim better appreciate her.''': 1,
    "Jim is her husband by the way.": 1,
    "I've only seen them together a few times and they seem happy enough but you never really know what goes on behind closed doors not that I'm implying anything I'm just saying you never know but I'm also not NOT saying it like I could imagine Jim doing something objectionable like he's got that vibe you know like it's not even anything specific I could point to there's just probably like a red flag there somewhere you know?": 1,
    "So, SAOA 19's coming along quite nicely. There have been some slight growing pains as Matty gets used to editing with DaVinci Resolve, but thankfully there are enough similarities to Premiere Pro that he's moving past them quickly, and is very excited to dig into what it's capable of! He's doing a great job and we all love how it's looking so far.": 1,
    "As for MHAA 5, Carrie's finished laying out three of nine scenes and she's already sent those off to Spencer for lip flapping as she moves on to scene four. There's some really fun visual edits in this one, as well as new cast members, that we're so excited to inflict upon you XD.": 1,
    "Now for the REALLY big news! I just heard that Janice and Jim are going to marriage counseling. Obviously, I hope they can work things out, but I don't know. When I heard about it I got this weird sense of joy. Like, what's that about? Makes me think...": 1,
    "Oh right! Fuck! The ACTUAL big news!": 1,
    "We've been working on a secret thing in our downtime since... 2019? Jesus. Fuckin' time gumbo.": 1,
    "Anyway, we've been quietly working on it for a long time, and it's FINALLY ready to show off. Carrie is forcing us to do this and is practically FROTHING with anticipation. Make of that what you will~": 1,
    "The preview's gonna go live on YouTube on January 31st at 1PM PST, then we'll be showing the FULL episode on Twitch after SWE&D, so roughly 6PM or so. And of course, it will also be available on our Patreon the same day. In case you're curious, yes, it has already been taken to copyright jail. Should be out in a month or so. Three weeks with good behavior. WE'RE SO EXCITED, Y'ALL! SEE YOU IN STREAM!!!": 1,
    "By the way, I've been tailing Jim for a couple weeks now. Nothing weird, just to make sure he's treating Janice like the goddess she is, and I gotta tell ya, that man's been up to some pretty sketch shit. You wouldn't believe the kinds of places I caught him going. What do you need at Home Depot, Jim! You've already got a home! With a beautiful family! Disgraceful.": 1,
    "I bet he's the one that's been impersonating us on Facebook lately. Best be on the lookout for that. We stopped using Facebook years ago, so if anyone on there claims to be us, it's probably fucking Jim.": 1,
    "Do y'all think I might like Janice?": 1,
    "I mean, that's crazy right? She's a married woman.": 1,
    "But like, when she's around, I do get light-headed, and my throat starts to close up. Granted, that's because of the peanut butter squares she made for everyone, but how could I let something as silly as a life-threatening allergy keep me from partaking in the ambrosia that is the baking of that absolute angel who graces us mortals with her oh fuck I'm in love with Janice...": 1,
    "Do you think she knows?! Has it been obvious to everyone but me this whole time?! Oh god, I can never tell her. It'd just cause problems for her and her family. I don't want to be the reason her kids grow up in a broken home! But... what if we're truly destined for each other? What if we're soulmates who just met each other at the wrong time?! I really think I could make her happy...": 1,
...
BLACK_CODERS:dict = {
    "I wouldn't have struggled in Phil's gauntlet if I'd had ______." : 1,
    "______ was the only thing that could stop my emotional breakdown after not being able to find that bug.": 1,
    ...
    "I got food poisoning from Sodexo after trying their ______.": 1,
    "Thanks to my junior project team members, ______.": 1,
    "Instead of socializing at the alumni BBQ, I was doing ______.": 1,
    "Using VI is like ______.": 1,
    "______ is just one feature of our new app!": 1,
    "_____. It's a feature, not a bug.": 1,
    "I asked you to kill my processes, but you ended up killing ______.": 1,
    "Uhhh... Guys... I think I broke ______.": 1,
    "______ is a good name for a Jira ticket.": 1,
    "Doing ______ always creates zombie processes.": 1,
    "Daemon threads aren't my only souvenir from hell. I also brought back ______.": 1,
    "Error on line 69: ______.": 1,
    "______ just caused my program to seg fault. :skull:": 1,
