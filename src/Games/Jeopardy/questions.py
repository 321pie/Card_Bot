...
ANDREW_R:list = [
    ...
    '''I will take the suffrage from you.''',
    ...
    '''Did someone order murder and blasphemy?''',
    '''It's a three-way!''',
    ...
    '''MY QUEEN!''',
    '''I know I ingested this peice of media...''',
...
ALEC_W:list = [
    ...
    '''Am I practicing my worm or am I practicing my lobster?''',
